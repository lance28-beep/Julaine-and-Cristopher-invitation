              ...
              <div className="bg-[#EDD6AC]/95 rounded-xl sm:rounded-2xl shadow-2xl border-2 border-[#A78256]/40 hover:shadow-[0_10px_50px_rgba(167,130,86,0.3)] transition-all duration-300 overflow-hidden">
                <div className="relative p-3 sm:p-4 md:p-5">
                  ...
                  <div className="flex items-center justify-center gap-2 sm:gap-2.5 mb-2 sm:mb-2.5">
                    <div className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 rounded-full bg-gradient-to-br from-[#C2D3C3] to-[#B28383] flex items-center justify-center flex-shrink-0 shadow-md">
                      <Download className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 text-white" />
                    </div>
                    <h4 className="font-playfair text-sm sm:text-base md:text-lg lg:text-xl font-bold text-[#A78256]">Upload Your Photos & Videos</h4>
                  </div>
                  
                  {/* Instructions */}
                  <p className="font-lora text-[#B28383] text-[10px] sm:text-xs md:text-sm mb-3 sm:mb-4 px-2 leading-relaxed text-center">
                  ...
                  <div className="mx-auto max-w-xs">
                    <div className="bg-gradient-to-br from-[#C2D3C3]/10 via-white to-[#B28383]/10 p-3 sm:p-4 rounded-2xl shadow-lg border-2 border-[#A78256]/30 mb-3 sm:mb-4">
                      <div className="bg-white p-2.5 sm:p-3 rounded-xl shadow-inner">
                        <div className="relative mx-auto w-fit">
                          ...
                          <div className="absolute -top-1 -left-1 w-3 h-3 border-t-2 border-l-2 border-[#C2D3C3] rounded-tl" />
                          <div className="absolute -top-1 -right-1 w-3 h-3 border-t-2 border-r-2 border-[#C2D3C3] rounded-tr" />
                          <div className="absolute -bottom-1 -left-1 w-3 h-3 border-b-2 border-l-2 border-[#C2D3C3] rounded-bl" />
                          <div className="absolute -bottom-1 -right-1 w-3 h-3 border-b-2 border-r-2 border-[#C2D3C3] rounded-br" />
                        </div>
                      </div>
                      
                      {/* Scan instruction */}
                      <p className="text-center mt-2 sm:mt-2.5 text-[9px] sm:text-[10px] md:text-xs text-[#B28383]/70 font-lora">
                    ...
                    <div className="space-y-2">
                      <div className="grid grid-cols-2 gap-2">
                        <button
                          ...
                          className="flex items-center justify-center gap-1.5 sm:gap-2 px-3 py-2 sm:py-2.5 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg text-[10px] sm:text-xs md:text-sm bg-gradient-to-r from-[#C2D3C3] to-[#B28383] text-white hover:from-[#C2D3C3]/90 hover:to-[#B28383]/90 font-medium"
                        >
                        ...
                        <button
                          ...
                          className="flex items-center justify-center gap-1.5 sm:gap-2 px-3 py-2 sm:py-2.5 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg text-[10px] sm:text-xs md:text-sm border-2 border-[#A78256]/40 hover:border-[#A78256]/60 bg-white hover:bg-[#A78256]/5 font-medium"
                          title="Copy link"
                        >
                          {copiedDriveQR ? (
                            <>
                              <Check className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#C2D3C3]" />
                              <span className="font-lora text-[#C2D3C3]">Copied!</span>
                            </>
                          ) : (
                            <>
                              <Copy className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#A78256]/60" />
                              <span className="font-lora text-[#A78256]">Copy Link</span>
                            </>
                          )}
                        </button>
                      </div>
                      ...
                      <div className="flex items-center gap-2 py-1">
                        ...
                        <span className="text-[9px] sm:text-[10px] text-[#B28383]/60 font-lora italic">or</span>
                        <div className="flex-1 h-px bg-gradient-to-r from-transparent via-[#A78256]/30 to-transparent" />
                      </div>
                      ...
                      <a
                        ...
                        className="flex items-center justify-center gap-2 w-full py-2 sm:py-2.5 px-3 rounded-lg bg-gradient-to-r from-[#A78256]/10 to-[#C2D3C3]/10 border-2 border-[#A78256]/30 hover:border-[#A78256]/50 transition-all duration-200 shadow-sm hover:shadow-md group"
                      >
                        <Share2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#C2D3C3] group-hover:scale-110 transition-transform" />
                        <span className="font-lora text-[10px] sm:text-xs md:text-sm text-[#A78256] group-hover:text-[#B28383] font-medium transition-colors">Open Google Drive</span>
                      </a>
                    </div>
                  </div>
                </div>
